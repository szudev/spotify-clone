...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb
      tabIndex={0}
      className='hidden group-hover:block group-focus:block hover:block focus:block h-3 w-3 rounded-full outline-none bg-white transition-colors disabled:pointer-events-none'
    />
  </SliderPrimitive.Root>
))
